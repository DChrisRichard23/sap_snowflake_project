view: b_currconvfactraw {
  sql_table_name: "S4HANA"."B_CURRCONVFACTRAW"
    ;;

  dimension: altexchratety_abwkt_curr {
    type: string
    sql: ${TABLE}."ALTEXCHRATETY_ABWKT_CURR" ;;
  }
  ...
  dimension: exratevalidfrom_abwga_curr {
    type: string
    sql: ${TABLE}."EXRATEVALIDFROM_ABWGA_CURR" ;;
  }
  ...
  dimension: validfrom_gdatu_invv {
    type: string
    sql: ${TABLE}."VALIDFROM_GDATU_INVV" ;;
  }
