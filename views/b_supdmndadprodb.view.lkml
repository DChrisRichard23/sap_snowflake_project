view: b_supdmndadprodb {
  sql_table_name: "S4HANA"."B_SUPDMNDADPRODB"
    ;;
  ...
  dimension: event_basedposting_fco_eb_post {
    type: string
    sql: ${TABLE}."EVENT_BASEDPOSTING_FCO_EB_POST" ;;
  }
  ...
  dimension: prodprocno_ckml_f_procnr {
    type: number
    sql: ${TABLE}."PRODPROCNO_CKML_F_PROCNR" ;;
  }
