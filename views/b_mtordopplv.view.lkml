view: b_mtordopplv {
  sql_table_name: "S4HANA"."B_MTORDOPPLV"
    ;;
  ...
  dimension: confactivity_co_rumng54 {
    type: number
    sql: ${TABLE}."CONFACTIVITY_CO_RUMNG54" ;;
  }
  ...
  dimension: forecastvalue_co_schaetz130 {
    type: number
    sql: ${TABLE}."FORECASTVALUE_CO_SCHAETZ130" ;;
  }
  ...
  dimension: standardvalue_vgwrt17 {
    type: number
    sql: ${TABLE}."STANDARDVALUE_VGWRT17" ;;
  }

  dimension: standardvalue_vgwrt19 {
    type: number
    sql: ${TABLE}."STANDARDVALUE_VGWRT19" ;;
  }

  dimension: standardvalue_vgwrt21 {
    type: number
    sql: ${TABLE}."STANDARDVALUE_VGWRT21" ;;
  }
  ...
  dimension: stdvalueunit_vgwrteh18 {
    type: string
    sql: ${TABLE}."STDVALUEUNIT_VGWRTEH18" ;;
  }

  dimension: stdvalueunit_vgwrteh20 {
    type: string
    sql: ${TABLE}."STDVALUEUNIT_VGWRTEH20" ;;
  }
  ...
  dimension: unit_activity_co_ismngeh170 {
    type: string
    sql: ${TABLE}."UNIT_ACTIVITY_CO_ISMNGEH170" ;;
  }
