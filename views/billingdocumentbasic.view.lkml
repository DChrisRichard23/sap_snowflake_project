view: billingdocumentbasic {
  sql_table_name: "S4HANA"."BILLINGDOCUMENTBASIC"
    ;;
  ...
  dimension: billgdocreqreflgclsyst {
    type: string
    sql: ${TABLE}."BILLGDOCREQREFLGCLSYST" ;;
  }

  dimension: billgdocreqrefsddoccategory {
    type: string
    sql: ${TABLE}."BILLGDOCREQREFSDDOCCATEGORY" ;;
  }
  ...
  dimension: billingdocrequestreference {
    type: string
    sql: ${TABLE}."BILLINGDOCREQUESTREFERENCE" ;;
  }
  ...
  dimension: overallbillingdocreqstatus {
    type: string
    sql: ${TABLE}."OVERALLBILLINGDOCREQSTATUS" ;;
  }
  ...
  dimension: overalldocumentbillingstatus {
    type: string
    sql: ${TABLE}."OVERALLDOCUMENTBILLINGSTATUS" ;;
  }
  ...
  dimension: prelimbillingdocumentstatus {
    type: string
    sql: ${TABLE}."PRELIMBILLINGDOCUMENTSTATUS" ;;
  }
  ...
  dimension: proposedbillingdocumenttype {
    type: string
    sql: ${TABLE}."PROPOSEDBILLINGDOCUMENTTYPE" ;;
  }
