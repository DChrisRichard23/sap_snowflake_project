view: b_projmlstnversn {
  sql_table_name: "S4HANA"."B_PROJMLSTNVERSN"
    ;;
  ...
  dimension: activate_trigg104 {
    type: string
    sql: ${TABLE}."ACTIVATE_TRIGG104" ;;
  }
  ...
  dimension: alternative_cn_plnal48 {
    type: string
    sql: ${TABLE}."ALTERNATIVE_CN_PLNAL48" ;;
  }

  dimension: alternative_cn_plnal50 {
    type: string
    sql: ${TABLE}."ALTERNATIVE_CN_PLNAL50" ;;
  }

  dimension: alternative_cn_plnal53 {
    type: string
    sql: ${TABLE}."ALTERNATIVE_CN_PLNAL53" ;;
  }
  ...
  dimension: counter_cim_count114 {
    type: number
    sql: ${TABLE}."COUNTER_CIM_COUNT114" ;;
  }

  dimension: counter_cim_count118 {
    type: number
    sql: ${TABLE}."COUNTER_CIM_COUNT118" ;;
  }

  dimension: counter_cim_count120 {
    type: number
    sql: ${TABLE}."COUNTER_CIM_COUNT120" ;;
  }

  dimension: counter_cim_count20 {
    type: number
    sql: ${TABLE}."COUNTER_CIM_COUNT20" ;;
  }

  dimension: counter_cim_count45 {
    type: number
    sql: ${TABLE}."COUNTER_CIM_COUNT45" ;;
  }
  ...
  dimension: executeonce_sgact98 {
    type: string
    sql: ${TABLE}."EXECUTEONCE_SGACT98" ;;
  }
  ...
  dimension: milesto1_neno_mlst_zaehl112 {
    type: number
    sql: ${TABLE}."MILESTO1NENO_MLST_ZAEHL112" ;;
  }

  dimension: milesto1_neno_mlst_zaehl117 {
    type: number
    sql: ${TABLE}."MILESTO1NENO_MLST_ZAEHL117" ;;
  }

  dimension: milesto1_neno_mlst_zaehl119 {
    type: number
    sql: ${TABLE}."MILESTO1NENO_MLST_ZAEHL119" ;;
  }
  ...
  dimension: processstage_actlv68 {
    type: string
    sql: ${TABLE}."PROCESSSTAGE_ACTLV68" ;;
  }
  ...
  dimension: selectionprof_sesma86 {
    type: string
    sql: ${TABLE}."SELECTIONPROF_SESMA86" ;;
  }
  ...
  dimension: statuschange_chang92 {
    type: string
    sql: ${TABLE}."STATUSCHANGE_CHANG92" ;;
  }
  ...
  dimension: stdnetwork_cn_plnnr47 {
    type: string
    sql: ${TABLE}."STDNETWORK_CN_PLNNR47" ;;
  }

  dimension: stdnetwork_cn_plnnr49 {
    type: string
    sql: ${TABLE}."STDNETWORK_CN_PLNNR49" ;;
  }

  dimension: stdnetwork_cn_plnnr52 {
    type: string
    sql: ${TABLE}."STDNETWORK_CN_PLNNR52" ;;
  }
  ...
  dimension: systemstatus_systa74 {
    type: string
    sql: ${TABLE}."SYSTEMSTATUS_SYSTA74" ;;
  }
  ...
  dimension: userstatus_ussta80 {
    type: string
    sql: ${TABLE}."USERSTATUS_USSTA80" ;;
  }
